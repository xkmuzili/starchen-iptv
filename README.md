...
星辰 · Stellar TV 是一款基于 Telegram Bot 的智能 IPTV 服务平台，为用户提供流畅的直播观看体验。

### ✨ 核心功能

| 功能 | 描述 |
|------|------|
| 🎬 **海量频道** | 覆盖央视、卫视、地方台、港澳台、海外华语等数百个直播源 |
...
| 🛠️ **管理面板** | 管理员可通过 Web 面板管理频道、用户、公告 |
| 🤖 **AI 智能客服** | 基于 AI 的自动客服，7×24 小时响应用户咨询 |
